             ...
             implements GeckoEventListener
{
    ...
    public void handleMessage(String event, JSONObject message) {
        ...
        try {
            ...
            // It's fine if the caller-provided token is null.
            final Object token = message.optJSONObject("token");

            // And a null permission means no permission.
            final String permission = message.optString("permission", null);
