...
add_task(function test_add_remove_observer() {
  ...
  try {
    ...
    do_check_eq(value1.aSubject, obs1);
    do_check_eq(value1.aTopic, "boolKey");
    do_check_eq(typeof(value1.aData), "boolean");
    do_check_eq(value1.aData, true);
  } finally {
  ...
  try {
    ...
    do_check_eq(value2.aSubject, obs2);
    do_check_eq(value2.aTopic, "boolKey");
    do_check_eq(typeof(value2.aData), "boolean");
    do_check_eq(value2.aData, false);
...
add_task(function test_observer_ignores() {
  ...
  try {
    ...
    do_check_eq(value.aSubject, obs);
    do_check_eq(value.aTopic, "charKey");
    do_check_eq(typeof(value.aData), "string");
    do_check_eq(value.aData, "a value");
  } finally {
