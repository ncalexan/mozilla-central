...
def main():
    ...
    if options.robocopIni != "":
        ...
        for test in robocop_tests:
            ...
            options.browserArgs.append("org.mozilla.gecko.robocop.tests.%s" % test['name'])
            options.browserArgs.append("%s/org.mozilla.gecko.robocop.FennecInstrumentationTestRunner" % options.remoteappname)
